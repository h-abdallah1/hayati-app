...
function readGlobal(): GlobalSettings {
  try {
    ...
    return {
      ...
      bgStyle: (["orbs", "ps3", "night", "stars", "rain", "matrix", "fireflies", "particles"] as const).includes(parsed.bgStyle as GlobalSettings["bgStyle"]) ? parsed.bgStyle as GlobalSettings["bgStyle"] : DEFAULT_GLOBAL.bgStyle,
    };
  } catch {
