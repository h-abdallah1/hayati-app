import { Dumbbell, Wallet, Clapperboard, Newspaper, Moon, Calendar, BookOpen, Target, FileText, Globe, type LucideIcon } from "lucide-react";
...
export const MODULES: ModuleDef[] = [
  ...
  { id: "goals",    label: "Goals",    description: "Annual goals and progress tracking",       panels: [],                    route: "/goals",   icon: Target       },
