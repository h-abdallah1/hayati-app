...
function OverviewTab({ workouts, count, streak, avgPerWeek, progress, selectedYear, C }: {
  ...
  const SectionLabel = ({ label }: { label: string }) => (
    <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 9, color: C.textFaint, letterSpacing: "0.6px", textTransform: "uppercase", marginBottom: 12 }}>{label}</div>
  );
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 40px", alignItems: "start" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
        ...
        {/* Top exercises */}
        <div>
          <SectionLabel label="top exercises" />
          <div>
...
function ExerciseChart({ title, workouts, C, onBack }: {
